...
const ContentSection = () => {
  const stats = [
    { label: "CPA", value: "40%" },
    { label: "Taux de conv.", value: "+30%" },
    { label: "ROI", value: "40%" },
    { label: "Quality Score", value: "20%" },
  ];
  return (
    <div className="bg-white py-24 sm:py-32" id="content">
          ...
          <div>
            <div className="text-base leading-7 text-gray-700 lg:max-w-lg">
              <div className="flex items-center">
                <h2 className="mt-2 text-4xl font-bold tracking-tight text-indigo-600 sm:text-5xl">
