...
const Header = (props) => {
  ...
  const callsToAction = [
    { name: "Une question ?", href: "contact", icon: LightBulbIcon },
    {
      name: "Reserver un call",
  ...
  const withBg = props.withBg || false;
  const handleClick = () => {
    setShowPanel(!showPanel);
  };
  const handleServiceClick = () => {
    setShowPanel(!showPanel); // Inversez l'état d'affichage
  };
  return (
    <header
      className={
        !withBg
          ? "bg-white fixed inset-x-0 top-0 z-50"
        ...
        <div className="flex lg:hidden">
          <button
            ...
            className={`-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 ${
              withBg ? "text-white" : "text-gray-700"
            }`}
          ...
          <Popover className="relative">
            <Popover.Button
              className={`flex items-center gap-x-1 text-sm font-semibold leading-6 ${
                withBg ? "text-white" : "text-gray-900"
              }`}
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              ...
              <div className="py-6">
                ...
                <a
                  href="https://calendly.com/adventure-contact/rendez-vous-decouverte?month=2023-03"
                  className="rounded-md bg-indigo-600 py-2.5 px-3.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 mt-7"
                >
                  Allons-y !
                </a>
              </div>
